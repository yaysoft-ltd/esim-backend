...
if (!file_exists($autoloadPath) || !is_dir($vendorPath)) {
    ...
    <head>
        ...
        <style>
            ...
            .installer-card { background: white; border-radius: 20px; box-shadow: 0 20px 40px rgba(0,0,0,0.1); padding: 40px; max-width: 600px; width: 90%; }
    ...
    <body>
        <div class="installer-card">
            ...
            <h3 class="text-center text-muted mb-4">Install Dependencies</h3>
            ...
            <p class="text-center mb-4">Your project needs Composer dependencies to be installed first.</p>

            <form method="POST" class="text-center">
                <div class="d-grid gap-2">
                    <button type="submit" name="run_composer" value="install" class="btn btn-primary btn-modern">
...
if (isset($_POST['install_app']) && $_POST['install_app'] === 'true') {
    ...
    $databaseSeederPath = dirname(__DIR__) . '/database/seeders/DatabaseSeeder.php';
    $sqlFilesPath = dirname(__DIR__) . '/database/seeders/sql/';
    ...
    if ($shouldRunSeeder) {
        ...
        $currencyMigrationExists = !empty(glob(dirname(__DIR__) . '/database/migrations/*_create_currencies_table.php'));
